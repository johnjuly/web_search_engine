...
│   ├── crawl.py           # 爬虫主程序
│   ├── help.py            # 辅助函数
│   └── default_urls.json  # 默认爬取URL配置
├── elastic-start-local/    # Elasticsearch 本地环境
...
# 缓冲区配置
NEW_URL_BUFFER_FLUSH_SIZE = 500    # 新URL内存缓冲区的最大大小
PROCESSED_PAGES_BUFFER_FLUSH_SIZE = 100  # 处理完成的页面数据内存缓冲区大小
```
